...
typedef struct __mavlink_attitude_t
{
 ...
 int32_t roll; ///< Roll angle (rad, -pi..+pi)
 int32_t pitch; ///< Pitch angle (rad, -pi..+pi)
 int32_t yaw; ///< Yaw angle (rad, -pi..+pi)
 int32_t rollspeed; ///< Roll angular speed (rad/s)
 int32_t pitchspeed; ///< Pitch angular speed (rad/s)
 int32_t yawspeed; ///< Yaw angular speed (rad/s)
} mavlink_attitude_t;

#define MAVLINK_MSG_ID_ATTITUDE_LEN 28
#define MAVLINK_MSG_ID_30_LEN 28

#define MAVLINK_MSG_ID_ATTITUDE_CRC 156
#define MAVLINK_MSG_ID_30_CRC 156
...
#define MAVLINK_MESSAGE_INFO_ATTITUDE { \
	...
	{  { "time_boot_ms", NULL, MAVLINK_TYPE_UINT32_T, 0, 0, offsetof(mavlink_attitude_t, time_boot_ms) }, \
         { "roll", NULL, MAVLINK_TYPE_INT32_T, 0, 4, offsetof(mavlink_attitude_t, roll) }, \
         { "pitch", NULL, MAVLINK_TYPE_INT32_T, 0, 8, offsetof(mavlink_attitude_t, pitch) }, \
         { "yaw", NULL, MAVLINK_TYPE_INT32_T, 0, 12, offsetof(mavlink_attitude_t, yaw) }, \
         { "rollspeed", NULL, MAVLINK_TYPE_INT32_T, 0, 16, offsetof(mavlink_attitude_t, rollspeed) }, \
         { "pitchspeed", NULL, MAVLINK_TYPE_INT32_T, 0, 20, offsetof(mavlink_attitude_t, pitchspeed) }, \
         { "yawspeed", NULL, MAVLINK_TYPE_INT32_T, 0, 24, offsetof(mavlink_attitude_t, yawspeed) }, \
         } \
}
...
static inline uint16_t mavlink_msg_attitude_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
						       uint32_t time_boot_ms, int32_t roll, int32_t pitch, int32_t yaw, int32_t rollspeed, int32_t pitchspeed, int32_t yawspeed)
{
	...
	_mav_put_int32_t(buf, 12, yaw);
	_mav_put_int32_t(buf, 16, rollspeed);
	_mav_put_int32_t(buf, 20, pitchspeed);
	_mav_put_int32_t(buf, 24, yawspeed);
...
static inline void mavlink_msg_attitude_send(mavlink_channel_t chan, uint32_t time_boot_ms, int32_t roll, int32_t pitch, int32_t yaw, int32_t rollspeed, int32_t pitchspeed, int32_t yawspeed)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[MAVLINK_MSG_ID_ATTITUDE_LEN];
	_mav_put_uint32_t(buf, 0, time_boot_ms);
 ...
 */
static inline int32_t mavlink_msg_attitude_get_roll(const mavlink_message_t* msg)
{
 ...
 */
static inline int32_t mavlink_msg_attitude_get_pitch(const mavlink_message_t* msg)
{
 ...
 */
static inline int32_t mavlink_msg_attitude_get_yaw(const mavlink_message_t* msg)
{
 ...
 */
static inline int32_t mavlink_msg_attitude_get_rollspeed(const mavlink_message_t* msg)
{
 ...
 */
static inline int32_t mavlink_msg_attitude_get_pitchspeed(const mavlink_message_t* msg)
{
 ...
 */
static inline int32_t mavlink_msg_attitude_get_yawspeed(const mavlink_message_t* msg)
{
