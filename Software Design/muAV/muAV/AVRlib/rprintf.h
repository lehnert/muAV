...
extern "C" {
	...
	void rprintfProgStr(const char PROGMEM str[]);
	...
	void rprintfuint16_t(unsigned short data);	///< Print 16-bit hex number. Outputs four hex characters.
	void rprintfuint32_t(unsigned long data);	///< Print 32-bit hex number. Outputs eight hex characters.
