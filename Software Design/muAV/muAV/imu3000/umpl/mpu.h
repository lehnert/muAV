...
struct mpuirq_data {
	__uint32_t interruptcount;
	__u64 irqtime;
	__uint32_t data_type;
	__s32 data;
};
...
#define MPU_SUSPEND		_IOW(MPU_IOCTL, 0x30, __uint32_t)
#define MPU_RESUME		_IOW(MPU_IOCTL, 0x31, __uint32_t)
