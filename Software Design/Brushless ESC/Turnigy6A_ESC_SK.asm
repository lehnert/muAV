/*
 * Turnigy6A_ESC_SK.asm
 *
 *  Created: 17/10/2012 5:09:22 PM
 *   Author: SEA-ROBOT
 */ 
...
.if ESC == 1
.include "ESC1.inc"		; Turnigy Plush 6A (INT0 PWM)
.elif ESC == 2
.include "ESC2.inc"		; Turnigy Plush 6A (INT0 PWM)
.elif ESC == 3
.include "ESC3.inc"		; Turnigy Plush 6A (INT0 PWM)
.elif ESC == 4
.include "ESC4.inc"		; Turnigy Plush 6A (INT0 PWM)
.endif
...
.equ	STOP_RC_PULS	= 1060	; 1060 Stop motor at or below this pulse length
...
.equ	ENOUGH_GOODIES	= 20	; This many start cycles without timeout will transition to running mode (12)
